...
import { BsArrowDown, BsArrowUpShort, BsBarChartLine, BsCalendarCheck, BsEmojiLaughing, BsGoogle, BsQuestionCircle } from "react-icons/bs";
import { CgMathPlus } from "react-icons/cg";
import { CiMoneyBill, CiPalette } from "react-icons/ci";
import { DiCodepen } from "react-icons/di";
import { FaBalanceScale, FaBuilding, FaReact, FaRegMoneyBillAlt } from "react-icons/fa";
import { FcPicture } from "react-icons/fc";
import { GrCaretNext, GrFormPrevious } from "react-icons/gr";
import { HiOutlineChartPie } from "react-icons/hi";
import { IoIosArrowDown, IoIosArrowForward } from "react-icons/io";
import { MdAlternateEmail, MdComputer, MdDriveFileRenameOutline, MdExitToApp, MdOutlineBorderAll } from "react-icons/md";
import { RiCloseLine, RiDeleteBin2Line, RiEditLine, RiLockPasswordLine, RiSettings3Line, RiStockLine, RiVipCrownFill } from "react-icons/ri";
import { SlGraph } from "react-icons/sl";
import { TbBrandBitbucket, TbBrandSupabase, TbReportAnalytics } from "react-icons/tb";
import logo from "../assets/inventarioslogo.png";
export const v = {
  iconoreportes: TbReportAnalytics,
  iconoempresa: FaBuilding,
  iconocategorias: MdComputer,
